...
export const teamQueryOptions = (teamId: string) =>
	queryOptions({
		...
		queryFn: () =>
			getTeamByIdFn({ data: { id: teamId }, headers: getAuthHeaders() }),
	});
...
export const teamMembersQueryOptions = (teamId: string) =>
	queryOptions({
		...
		queryFn: () =>
			getTeamMembersFn({ data: { teamId }, headers: getAuthHeaders() }),
	});
...
export const teamInvitationsQueryOptions = (teamId: string) =>
	queryOptions({
		...
		queryFn: () =>
			getTeamInvitationsFn({ data: { teamId }, headers: getAuthHeaders() }),
	});
