...
import { Plus, MoreHorizontal, Shield, ShieldCheck, User, Trash2, UserCog } from "lucide-react";
...
export function TeamMembersList({ teamId }: TeamMembersListProps) {
  ...
  const { data: invitations, isPending: invitationsLoading } = useTeamInvitations(teamId);
      ...
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Are you sure you want to remove {removingMember?.userName} from the team?
              They will no longer have access to team boards.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
