					...
					<FadeIn>
						<div className="text-center mb-16">
							...
							<p className="text-lg text-muted-foreground sm:text-xl max-w-3xl mx-auto leading-relaxed">
								Start your journey to becoming a full stack engineer. With
								average salaries of $130k+, this investment pays for itself in
								months. Choose the plan that fits your learning style.
							</p>
						</div>
					</FadeIn>
				)}
					...
					<div className="mt-16 max-w-2xl mx-auto">
						<div className="glass-card p-8 rounded-2xl text-center">
							...
							<p className="text-muted-foreground mb-4 text-lg">
								If you increase your salary by just $30k (from $50k to $80k), a
								$99/month plan pays for itself in{" "}
								<span className="font-bold text-primary">3.3 months</span>.
							</p>
							<p className="text-sm text-muted-foreground font-medium">
								Average full stack engineer salary: $130k. Most members see
								salary increases of $40k-$80k+.
							</p>
						</div>
					</div>
				</FadeIn>
