				...
				<FadeIn>
					<div className="text-center mb-16">
						...
						<p className="text-lg text-muted-foreground sm:text-xl max-w-3xl mx-auto leading-relaxed">
							We've built a comprehensive platform that addresses every aspect
						...
						<div className="relative z-10 flex flex-col justify-between h-full">
							...
							<div>
								...
								<p className="text-muted-foreground max-w-lg">
									Follow a proven curriculum designed by industry experts. No
									guesswork - just clear steps from beginner to full stack
									engineer.
								</p>
							</div>
						</div>
					...
					<div className="md:col-span-1 md:row-span-2 glass-card gradient-border p-8 rounded-2xl relative overflow-hidden group">
						<div className="relative z-10 h-full flex flex-col">
							...
							<p className="text-muted-foreground mb-8">
								Build portfolio projects that showcase your skills. Learn by
								doing, not just watching tutorials.
							</p>
							...
							<div className="mt-auto bg-slate-950 dark:bg-slate-950 p-4 rounded-lg border border-border font-mono text-xs text-white dark:text-slate-300 overflow-hidden shadow-inner group-hover:border-primary/30 transition-colors">
								<div className="opacity-70 select-none space-y-1">
									...
									<p>
										<span className="text-purple-400">git</span> push origin
										main
									</p>
									...
									<p className="text-slate-500">
										Writing objects: 100% (15/15), 2.3 KiB.
									</p>
