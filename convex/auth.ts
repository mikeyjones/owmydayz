...
const authSecret = process.env.BETTER_AUTH_SECRET || process.env.AUTH_SECRET || "development-secret-change-in-production-12345";
 ...
 */
export function requireUserFromClientId(userId: string | undefined): { id: string } {
  if (!userId) {
